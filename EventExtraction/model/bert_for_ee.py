...
from EventExtraction.layers.crf import CRF
from EventExtraction.model.nezha import NeZhaModel, NeZhaConfig
from EventExtraction.utils.utils_ee import ChineseTokenizer
...
MODEL_TYPE_CLASSES = {
    ...
    "nezha": (NeZhaConfig, ChineseTokenizer, BertCRFForDuEE1Su)
}
